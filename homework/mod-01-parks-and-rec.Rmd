...
This assignment assumes that you have completed all the steps in the Canvas pages: "How to setup and access Posit Cloud" and on "How to prepare and submit a submission in Posit Cloud for Canvas." If you haven't yet done so, please pause and complete it before continuing.
