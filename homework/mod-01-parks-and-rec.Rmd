...
This assignment assumes that you have completed all the steps in the Canvas pages: "How to set up and access Posit Cloud" and on "How to prepare and submit a submission in Posit Cloud for Canvas." If you haven't yet done so, please pause and complete it before continuing.
...
-   **Posit Cloud** The online service for accessing RStudio. 
    ...
    -   In this course, assignment instructions you work on (HWs, Labs, Exams) will be available on Canvas. The "starter" documents needed to complete each assignment will also be available on Posit Cloud.
...
-   It's only when you're in the course workspace that your usage of Posit 
Cloud won't count towards the free usage limits.
